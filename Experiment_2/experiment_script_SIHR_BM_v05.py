...
rng = np.random.default_rng(int(run+int(argv[1])*50))
...
np.savez_compressed(f'./Experiment_2/results/results_decorrelation_time_{decorrelation_time}_days_run_{run}.npz',particle_distribution = output['particle_distribution'],
